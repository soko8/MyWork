...
public class test {
	...
	public static void main(String[] args) {
		...
		BFS.bfs(dg, A.getVertexId(), B.getVertexId());
		
		System.err.println(BFS.getMinPath());
		System.err.println(BFS.getMinWeight());
		System.err.println(BFS.getMaxPath());
		System.err.println(BFS.getMaxWeight());
